...
<div
  ...
  aria-modal="true"
>
  <div class="w-full max-w-md rounded-lg bg-background border border-border shadow-xl p-6 space-y-4">
    ...
    <form onsubmit={handleSubmit} class="space-y-4">
      ...
      <div class="space-y-2">
        <label for="ws-desc" class="text-sm font-medium">Description <span class="text-muted-foreground">(optional)</span></label>
        <input
          id="ws-desc"
          type="text"
